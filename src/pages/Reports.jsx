  ...
  return (
    <div className="rp-root">
      <style>{`
        ...
        .rp-pdf-doc:hover { transform: rotate(0deg) scale(1.01); }
        ...
        .rp-pdf-brand span { color: #ff9800; }
        ...
        .rp-pdf-row:last-of-type { border-bottom: none; }
        .rp-pdf-row .dv { font-weight: 700; color: #000; }
        .rp-pdf-row .dv.g { color: #16a34a; }
        .rp-pdf-row .dv.r { color: #dc2626; }
        ...
        <motion.div className="rp-ed-visual" {...revealD(0.14)}>
          <div className="rp-pdf-doc">
            <div className="rp-pdf-header">
              <div className="rp-pdf-brand">KOR<span>AQ</span></div>
              <div className="rp-pdf-tag-chip">PDF Statement</div>
            </div>

            <div className="rp-pdf-period">1 Apr 2026 → 30 Apr 2026</div>

            <div className="rp-pdf-big">₦1,011,800</div>

            {[
              { label: 'Total Revenue',        val: '₦1,107,000', cls: 'g' },
              { label: 'Operating Costs',      val: '₦95,200',    cls: 'r' },
              { label: 'Net Profit Margin',    val: '+91.4%',      cls: 'g' },
              { label: 'Transactions',         val: '6',           cls: ''  },
              { label: 'Avg. Daily Income',    val: '₦32,638',     cls: 'g' },
            ].map(({ label, val, cls }, i) => (
              <div className="rp-pdf-row" key={i}>
                <span>{label}</span>
                <span className={`dv ${cls}`}>{val}</span>
              </div>
            ))}

            <div className="rp-pdf-footer">
              <div className="rp-pdf-wa">
                <div className="rp-pdf-wa-dot" />
                Share via WhatsApp
              </div>
              <div className="rp-pdf-stamp">Generated by Koraq</div>
            </div>
          </div>
        </motion.div>
      </section>
